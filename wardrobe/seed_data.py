...
Only the ten work-outfits looks (plus the hidden roll-neck) live here now.
Everything else — the seven killer looks and the 28 fits with renders — comes
from data/fits.json, the 2026-08-27 export, via wardrobe/fits_json.py. This file
keeps the ten because they are the one source that references garments by
display name, and names are not unique.
